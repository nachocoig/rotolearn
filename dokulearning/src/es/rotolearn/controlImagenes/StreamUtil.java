...
public class StreamUtil {
    ...
    /**
     * Copies input stream to writter using buffer and specified encoding.
     */
    public static void copy(InputStream input, Writer output,
    ...
    /**
     * Copies specified number of bytes from input stream to writter using buffer and specified encoding.
     */
    public static void copy(InputStream input, Writer output,
            String encoding, int byteCount) throws IOException {
        if (encoding == null) {
     ...
     */
    public static void copy(Reader input, OutputStream output,
            String encoding, int charCount) throws IOException {
        if (encoding == null) {
    ...
    /**
     * Reads all availiable bytes from InputStream as a byte array.
     ...
     * depends on stream implementation of <code>availiable()</code>.
     * Buffered internally.
     */
    public static byte[] readAvailableBytes(InputStream in)
        ...
        if (i < l) {
            throw new IOException(
                    "Could not completely read from input stream.");
        }
        return byteArray;
    }
