                         ...
                         <li><a href="#" rel="popover" data-placement="bottom" data-popover-content="#myPopover" id="leer">
                        	...
                        	<div id="myPopover" class="hide">
                        		...
                        		<%}else{ 
                        		 ...
                        		 <form method="POST" action="busquedaAvanzada.form"  enctype="multipart/form-data">
					                                		<input type="hidden" value="busqueda" name="tipo"/>	
